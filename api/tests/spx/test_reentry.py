...
def _ceiling():
    return _line("SWING_HIGH_DESC", 5872.40, 23, -1.00)


def _floor():
    return _line("SWING_LOW_ASC", 5848.20, 17, 1.00)
...
def test_above_armed_without_qualifying_candle():
    ...
    # Ceiling at 09:00 today = 5872.40 - 10 * 1.00 = 5862.40
    bar = Candle(
...
def test_above_triggered_by_bearish_touch_and_close_above():
    # Bearish candle that touches the ceiling and closes above.
    bar = Candle(
        t=datetime(2026, 5, 8, 9, tzinfo=CT),
...
def test_below_triggered_by_bullish_touch_and_close_below():
    ...
    # Floor at 09:00 today = 5848.20 + 16 * 1.00 = 5864.20
    bar = Candle(
        t=datetime(2026, 5, 8, 9, tzinfo=CT),
