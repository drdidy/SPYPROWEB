...
def es_candles_ascending_inside() -> list[Candle]:
    ...
    Tuned so:
      ...
      Prev RTH control high:     5878.50 at 13:00
      Prev RTH dealer low:       5849.00 at 09:00
    """
    ...
    bars.append(_bar(prev_day.replace(hour=12), o=5874.00, c=5874.00, h=5875.00, l=5867.00))
