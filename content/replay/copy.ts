export const replayCopy = {
  ...
  chart: {
    ...
    empty: "Choose Yesterday or Last Session to load the replay workspace.",
    partial:
      "Showing the slices that resolved for this date. Missing panels stay explicit rather than empty.",
  },
  tapeStrip: {
    title: "Engine tape",
    empty: "No events are recorded along this timeline yet.",
  },
};
