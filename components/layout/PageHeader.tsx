...
const sourcePalette: Record<LiveSnapshotSource, { cls: string; dot: string }> =
  {
    ...
    error: {
      cls: "bg-bear-tint text-[#8D281F] shadow-[inset_0_0_0_1px_rgba(181,48,30,0.30)]",
      dot: "bg-bear",
    },
  };

const sourceLabel: Record<LiveSnapshotSource, string> = {
  live: "Fresh read",
  degraded: "Limited",
  seed: "Standby",
  mock: "Preview",
...
export function PageHeader({
  ...
  return (
    <header className="contrast-dark relative overflow-hidden rounded-[16px] border border-[#D6BC75]/38 bg-[#071116] px-5 py-4 text-paper shadow-[0_22px_56px_-42px_rgba(7,17,22,0.95)] md:px-6 md:py-5">
