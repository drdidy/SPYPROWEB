...
export const navIndex: NavItem[] = [
  ...
  { label: "Options Lens", href: "/options", group: "Workspace" },
  { label: "Stocks", href: "/stocks", group: "Workspace" },
  { label: "Crypto Engine", href: "/crypto", group: "Workspace" },
  { label: "Planning Lab", href: "/foresight", group: "Workspace" },
  { label: "Market Context", href: "/context", group: "Intelligence" },
  { label: "Daily Brief", href: "/brief", group: "Intelligence" },
  { label: "Learning Center", href: "/learn", group: "Intelligence" },
  { label: "Signal Ledger", href: "/log", group: "Journal" },
  { label: "Workspace", href: "/settings", group: "Journal" },
];
